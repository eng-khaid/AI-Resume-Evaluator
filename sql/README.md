...
3. The user enters a target job description.
4. The system extracts text from the uploaded resume.
5. Resume content and job requirements are processed by OpenAI.
6. The AI generates a detailed evaluation report.
7. Results are displayed to the user through the web interface.
